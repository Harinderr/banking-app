...
//   const bank2  = document.getElementById('bank-2')
    ...
    <aside className='right-sidebar w-[550px] h-screen shadow-lg'>
        <section>
            <div className=" relative">
                ...
                <div className="aboslute -top-10 left-5 text-xl font-bold profile rounded-full h-20 w-20 text-white bg-bankGradient flex justify-self-center items-center ">{user?.firstName.slice(0,1).toUpperCase()}</div>
            ...
            <div className=" left-8 relative">
                <div onClick={()=> handleClick('bank-1')} id='bank-1' className={`z-${bank1Index} absolute  left-0 top-0 flex flex-col justify-between p-2  bg-bankGradient w-64 h-36  rounded-md`}>
                ...
                <div onClick={()=> handleClick('bank-2')} id='bank-2' className={`z-${bank2Index} absolute flex flex-col justify-between p-2 left-8 top-8 bg-slate-700 w-64 h-36  rounded-md `}>
